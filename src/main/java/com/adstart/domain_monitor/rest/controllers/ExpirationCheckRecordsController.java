...
public class ExpirationCheckRecordsController {
    ...
    public Page<GetExpirationCheckRecordResponse> getAllRecords(@RequestParam(defaultValue = "0") int page,
                                                                @RequestParam(defaultValue = "5") int size) {

        Pageable pageable = PageRequest.of(page, size);
        return expirationCheckRecordsWebProcessor.getExpirationCheckRecords(pageable);
    }
}
